...
interface DeliveryChallanDao {
    @Query("SELECT * FROM delivery_challans WHERE customerId = :customerId AND isPaid = 0")
    suspend fun getUnpaidChallansForCustomer(customerId: String): List<DeliveryChallanEntity>
