package com.tarsil.distribution.worker
...
import com.tarsil.distribution.network.ReconcileRequest
import com.tarsil.distribution.network.TarsilApiService
...
class SyncWorker(
    ...
    override suspend fun doWork(): Result {
        ...
        val apiService = retrofit.create(TarsilApiService::class.java)
